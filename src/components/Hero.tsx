      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 sm:px-6 lg:px-12 pt-36 sm:pt-20 pb-20 sm:pb-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
          ...
          <div className="text-left">
            ...
            <h1
              className="text-navy-darker text-[38px] sm:text-5xl lg:text-[72px] font-display font-medium leading-[1.1] sm:leading-[0.97] tracking-tight mb-6 sm:mb-6 animate-fade-in-up"
            ...
            <p
              className="text-gray-600 text-[15px] sm:text-lg leading-[1.75] sm:leading-relaxed mb-10 sm:mb-8 max-w-xl animate-fade-in-up"
